...
//
// SCIRenderableSeriesAnimationProtocol.h is part of SCICHART®, High Performance Scientific Charts
 ...
 */
@property (nonatomic, nullable) id<SCIRenderableSeriesProtocol> parentRenderableSeries;
