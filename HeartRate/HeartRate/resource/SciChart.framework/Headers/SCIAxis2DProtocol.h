...
//
// SCIAxis2DProtocol.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * Clips range to axis' visibleRangeLimit using current visibleRangeLimitMode
 */
-(void) clipRangeToVisibleRangeLimit:(id<SCIRangeProtocol>)range;
