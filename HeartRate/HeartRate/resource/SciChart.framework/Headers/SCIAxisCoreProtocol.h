...
//
// SCIAxisCoreProtocol.h is part of SCICHART®, High Performance Scientific Charts
 ...
 * @see SCIGenericType
 */
- (SCIGenericType)getDataValue:(double)pixelCoordinate __deprecated_msg("please use coordinate calculator to convert to data value");
