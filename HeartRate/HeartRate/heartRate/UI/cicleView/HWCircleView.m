...
#define KHWCircleColor [UIColor colorWithRed:54.0/255.0 green:216.0/255.0 blue:63/255.0 alpha:1]
...
-(void)initParam{
    _padding = 0;
    _progressColor = [UIColor colorWithRed:0/255.0 green:191/255.0 blue:255/255.0 alpha:1];
}
...
- (void)drawRect:(CGRect)rect
{
    ...
    //半径
    CGFloat radius = (MIN(rect.size.width, rect.size.height) - KHWCircleLineWidth) * 0.5-5;
